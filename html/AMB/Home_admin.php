     ...
     <div class="container-fluid">
       <div class="row">
         <div class="col text-center">
           ...
           <h2 class="mt-3">Hola {{ user.name }}</h2>
         </div>
         <div class="col text-center">
           <button type="button" class="btn btn-primary btn-lg">Ver excursiones</button>
         </div>
         <div class="col text-center">
           <button type="button" class="btn btn-primary btn-lg">Cargar excursión</button>
         </div>
         <div class="col text-center">
